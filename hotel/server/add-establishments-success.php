<?php
header("location:http://localhost:4200/#/add-establishment-success-page");
...
$establishmentsList = file_get_contents('../holidaze/src/assets/data/establishments.json');
...
file_put_contents('../holidaze/src/assets/data/establishments.json', $jsonData);
?>
